...
const PageComponent = () => {
  ...
  const handleEditClick = (dataToEdit: { id: React.SetStateAction<string>; name: React.SetStateAction<string>; nip: React.SetStateAction<string>; nik: React.SetStateAction<string>; alamat: React.SetStateAction<string>; email: React.SetStateAction<string>; }) => {
    setName(dataToEdit.name);
    setNip(dataToEdit.nip);
    setNik(dataToEdit.nik);
  ...
  const handleSave = async () => {
    ...
    try {
      const response = await fetch('/api/user/change_data', {
        method: 'POST',
        headers: {
      ...
      <div className="p-col-12">
        ...
        />
            ...
            <DataTable value={data} paginator rows={5} rowsPerPageOptions={[5, 10, 25, 50]} tableStyle={{ minWidth: '50rem' }}
              ...
              <Column field="nik" header="NIK" style={{ width: '25%' }}></Column>
